...
public class ModelPowerMatrix extends ModelBase
{
  ...
  public void bounceAnimation(){
	  littleCube.offsetY = littleCube.offsetY + 0.5f;
	  littleCube2.offsetY = littleCube2.offsetY + 0.5f;
	  littleCube3.offsetY = littleCube3.offsetY + 0.5f;
	  littleCube4.offsetY = littleCube4.offsetY + 0.5f;
  ...
  public void rotateAnimation(){
	  ...
	  if (randInt == 1){
		  for (int angle = 1; angle<360; angle++) //Rotate Around The X Axis
			  MainCube.rotateAngleX = MainCube.rotateAngleX + 1f;
	  }else if (randInt == 2){
		  for (int angle = 1; angle<360; angle++) //Rotate Around The Y Axis
			  MainCube.rotateAngleY = MainCube.rotateAngleY + 1f;
	  } else if (randInt == 3){
		  for (int angle = 1; angle<360; angle++) //Rotate Around The Z Axis
			  MainCube.rotateAngleZ = MainCube.rotateAngleZ + 1f;
	  } else {
		  for (int bounceAmt = 1; bounceAmt<5; bounceAmt++) //Bounce Up
			  MainCube.rotateAngleZ = MainCube.rotateAngleZ + 1f;
		  
		  for (int bounceAmt = 1; bounceAmt<5; bounceAmt++) //Bounce Down
			  MainCube.rotateAngleZ = MainCube.rotateAngleZ - 1f;
	  }
  }
}
