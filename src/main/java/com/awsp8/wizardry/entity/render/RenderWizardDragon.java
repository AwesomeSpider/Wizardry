...
public class RenderWizardDragon
				extends RenderLiving{

	public RenderWizardDragon(ModelBase modelBase, float par2) {
		super(modelBase, par2);
	}

	@Override
	protected ResourceLocation getEntityTexture(Entity var1) {
		return new ResourceLocation("wizardry", "/textures/entities/dragon.png");
	}
}
